(function ($) {
	...
	$('.cat-toggle-btn').on('click', function (event) {
		event.stopPropagation();
		$('.cat__menu').slideToggle(500);
		$('.side-menu').slideUp(500); // Close other menu if open
	});

	$('.cat-toggle-btn-2').on('click', function (event) {
		event.stopPropagation();
		$('.side-menu').slideToggle(500);
		$('.cat__menu').slideUp(500); // Close other menu if open
	});

	// Close menus when clicking anywhere outside
	$(document).on('click', function () {
		$('.cat__menu').slideUp(500);
		$('.side-menu').slideUp(500);
	});

	// Prevent closing when clicking inside the menus
	$('.cat__menu, .side-menu').on('click', function (event) {
		event.stopPropagation();
	});
	...
	if (jQuery(".cetagory-slider").length > 0) {
		let testimonialTwo = new Swiper('.cetagory-slider', {
			slidesPerView: 1,
			spaceBetween: 0,
			// direction: 'vertical',
			loop: true,
	...
	// 11. Product Slider Activation Js
	if (jQuery(".product-slider-t").length > 0) {
		let testimonialTwo = new Swiper('.product-slider-t', {
			slidesPerView: 1,
			spaceBetween: 0,
			// direction: 'vertical',
			loop: true,
...
$(document).ready(function () {
	$(".count_dropdown img.flag").addClass("flagvisibility");

	$(".count_dropdown dt a").click(function () {
		$(".count_dropdown dd ul").toggle();
	});
	...
	$(document).bind('click', function (e) {
		...
		if (!$clicked.parents().hasClass("count_dropdown"))
			$(".count_dropdown dd ul").hide();
	});


	$("#flagSwitcher").click(function () {
		$(".count_dropdown img.flag").toggleClass("flagvisibility");
	});
});
